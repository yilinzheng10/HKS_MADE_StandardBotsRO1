standard_bots_description
==========================================

Description package for standard bots robots.
...
2. Install the package by calling `colcon build --symlink-install --packages-select standard_bots_description`
3. (Re-)Source environment `source install/setup.bash`
4. Launch description test:
   ```
   ros2 launch standard_bots_description view_sbot.launch.py
   ```
